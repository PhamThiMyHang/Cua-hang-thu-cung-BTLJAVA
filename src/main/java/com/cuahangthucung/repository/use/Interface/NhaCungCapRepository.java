...
import com.cuahangthucung.dto.use.nhacungcap.NhaCungCapSummaryDTO;
...
public interface NhaCungCapRepository extends JpaRepository<NhaCungCap, String>, JpaSpecificationExecutor<NhaCungCap> {
    ...
    // Bổ sung vào NhaCungCapRepository.java nếu cần phục vụ Dashboard thống kê
    @Query("SELECT new com.cuahangthucung.dto.use.nhacungcap.NhaCungCapSummaryDTO(COUNT(n)) FROM NhaCungCap n")
    NhaCungCapSummaryDTO layThongKeTongQuanNhaCungCap();
